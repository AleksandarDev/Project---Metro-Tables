...
namespace MetroTables.ThirdParty.BasicOperators {
	...
	[ExportMetadata("Operation", "Addition")]
	public class Addition : BasicOperator {
		public override string Symbol { get { return "+"; } }
		


		public Addition() : this(null, null) { }
		public Addition(dynamic first, dynamic second) {
		...
		public override dynamic TryParse(params dynamic[] args) {
			...
			// If two operands and symbol is passed
				...
				return new Addition(args[0], args[2]);
			}
