...
namespace MetroTables.ThirdParty.BasicOperators {
	...
	[ExportMetadata("Operation", "Multiplication")]
	public class Multiplication : BasicOperator {
		public override string Symbol { get { return "*"; } }


		public Multiplication() : this(null, null) { }
		public Multiplication(dynamic first, dynamic second) {
		...
		public override dynamic TryParse(params dynamic[] args) {
			...
			// If two operands and symbol is passed
				...
				return new Multiplication(args[0], args[2]);
			}
